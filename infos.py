teams_dict = {
    ...
    "Botafogo": {"City": "Rio de Janeiro", "Stadium": "Nilton Santos"},
    "Corinthians": {"City": "São Paulo", "Stadium": "Neo Quimica Arena"},
    "São Paulo": {"City": "São Paulo", "Stadium": "Morumbis"},
...
stadiums_dict = {
    ...
    "Neo Quimica Arena": {"Stadium City": "São Paulo"},
    "Morumbis": {"Stadium City": "São Paulo"},
    "Vila Belmiro": {"Stadium City": "São Paulo"},
    "Allianz Parque": {"Stadium City": "São Paulo"}
}
